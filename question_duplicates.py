...
def data_generator(Q1, Q2, batch_size, pad=1, shuffle=True):
    ...
    while True:
        ...
        if len(input1) == batch_size:
            ...
            max_len = max(max([len(t) for t in input1]), max([len(t) for t in input2]))
...
question1 = "What's going on with the stock market?"
question2 = "Is the stock market going to crash?"
